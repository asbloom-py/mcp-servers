# GitHub MCP Server
[![smithery badge](https://smithery.ai/badge/@asbloom-py/mcp-servers)](https://smithery.ai/server/@asbloom-py/mcp-servers)
...
To install GitHub MCP for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@asbloom-py/mcp-servers):

```bash
npx -y @smithery/cli install @asbloom-py/mcp-servers --client claude
```
